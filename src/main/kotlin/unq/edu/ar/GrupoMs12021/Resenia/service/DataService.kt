...
class DataService(private val titleDAO : TitleDAO) : ApplicationRunner{
    ...
    val title2: Title = Title.createTitleWith("tt0000002", TitleBasicInformation(TitleType.MOVIE, "American Beer", 2004, null, 105, listOf(Genres.DOCUMENTARY)), listOf(), cast2)
    val title3: Title = Title.createTitleWith("tt0000003",TitleBasicInformation(TitleType.TVSERIES, "All About You", 1874, null, 15, listOf(Genres.DOCUMENTARY, Genres.FAMILY)), listOf(), cast3)
    val title4: Title = Title.createTitleWith("tt0000004",TitleBasicInformation(TitleType.MOVIE, "The Fast Express", 1942, null, 22, listOf(Genres.ACTION, Genres.DRAMA, Genres.THRILLER)), listOf(), cast4)
